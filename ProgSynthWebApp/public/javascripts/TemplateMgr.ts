...
"use strict";
import psJqueryUtils = require("PSJqueryUtils");
...
export function getTemplate(name) {
    switch (name) {
        case "abstractVal": return abstractValTemplate;
        case "primitiveVal": return primitiveValTemplate;
        case "compositeVal": return compositeValTemplate;
        case "fieldVal": return fieldValTemplate;
        case "listVal": return listValTemplate;
        case "tupleVal": return tupleValTemplate;
        case "inputForm": return inputFormTemplate;
        case "siblingsView": return siblingsViewTemplate;
        case "enumView": return enumViewTemplate;
        case "newVarView": return newVarViewTemplate;
    }
    throw new Error("template not found: " + name);
}
