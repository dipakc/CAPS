define(["require", "exports", "TypeViews", "TypeTVs"], function(require, exports, typeViews, typeTVs) {
    typeViews;
    typeTVs;
    ...
    function createViewFromTVName(tvName) {
        ...
        var tvClass = exports.getClass(tvName);
        var viewClass = exports.getClass(viewName);

        var tvClassObj = new tvClass();
        return new viewClass(tvClassObj);
    }
    exports.createViewFromTVName = createViewFromTVName;
    ...
    exports.init = _.once(registerTVs);
});
