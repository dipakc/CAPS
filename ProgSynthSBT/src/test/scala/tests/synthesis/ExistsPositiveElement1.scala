...
class ExistsPositiveElement1 extends FunSuite with ShouldMatchers with PSPluginTesterDbg {
	ignore("ExistsPositiveElement. NOT YET IMPLEMENTED") {
		val inputFileName = """src\test\scala\tests\synthesis\ExistsPositiveElement1Src.scala"""
		val outputFileName = """tests.synthesis.ExistsPositiveElement1.html"""
