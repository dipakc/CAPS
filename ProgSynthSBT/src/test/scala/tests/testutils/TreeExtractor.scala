...
/** Given a scala file, extracts an AST
 * Usage:
 * override compilerArgStr, cpEntries if needed.
 * call runCompiler with the files to be compiled as arguments.
 *    Example: runCompiler("""src\test\scala\tests\inputfiles\ExpnTest.scala"""::Nil)
 * call getFileTree to get AST of a file
 *    Example: getFileTree("ExpnTest.scala")
 * call getMethodTree to get AST of a method.
 */

trait TreeExtractor {
	val compilerArgStr = " -Ystop-after:refchecks"
