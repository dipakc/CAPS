...
trait PSTrees {
   ...
   */
  case class Modifiers(flags: Long, privateWithin: String, annotations: List[Tree], positions: Map[Long, Int]) {
  }
...
// ----- tree node alternatives --------------------------------------
  ...
  case class Template(parents: List[Tree], self: ValDef, body: List[Tree])
	...
	//   }
	// System.err.writeln0("TEMPLATE: " + parents)
  }
  ...
  case class SelectFromTypeTree(qualifier: Tree, name: String)
  ...
  case class SelectFromArray(qualifier: Tree, name: String, erasure: String)
